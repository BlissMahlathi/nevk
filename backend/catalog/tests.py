...
class CatalogTests(TestCase):
	...
	def test_product_image_save_creates_processed_storefront_image(self):
		...
		self.assertEqual(product_image.display_image.name, product_image.processed_image.name)
		self.assertTrue(
			product_image.processed_image.storage.exists(product_image.processed_image.name)
		)
